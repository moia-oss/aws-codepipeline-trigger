...
var AWS_TEMPLATE = "codepipeline.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "codepipeline.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "codepipeline.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "codepipeline.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "codepipeline.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(__assign({ signingService: "codepipeline" }, regionInfo));
};
