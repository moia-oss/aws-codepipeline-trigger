...
const serializeAws_json1_1MetricTransformation = (input, context) => {
    return {
        ...(input.defaultValue !== undefined &&
            input.defaultValue !== null && { defaultValue: smithy_client_1.serializeFloat(input.defaultValue) }),
...
const deserializeAws_json1_1DataAlreadyAcceptedException = (output, context) => {
    return {
        expectedSequenceToken: smithy_client_1.expectString(output.expectedSequenceToken),
...
const deserializeAws_json1_1Destination = (output, context) => {
    return {
        accessPolicy: smithy_client_1.expectString(output.accessPolicy),
        arn: smithy_client_1.expectString(output.arn),
        creationTime: smithy_client_1.expectLong(output.creationTime),
...
const deserializeAws_json1_1ExportTask = (output, context) => {
    return {
        ...
        destinationPrefix: smithy_client_1.expectString(output.destinationPrefix),
        executionInfo: output.executionInfo !== undefined && output.executionInfo !== null
            ...
            : undefined,
        from: smithy_client_1.expectLong(output.from),
        ...
        status: output.status !== undefined && output.status !== null
            ...
            : undefined,
        taskId: smithy_client_1.expectString(output.taskId),
        taskName: smithy_client_1.expectString(output.taskName),
        to: smithy_client_1.expectLong(output.to),
    };
};
const deserializeAws_json1_1ExportTaskExecutionInfo = (output, context) => {
    return {
        completionTime: smithy_client_1.expectLong(output.completionTime),
        creationTime: smithy_client_1.expectLong(output.creationTime),
    };
};
...
const deserializeAws_json1_1FilteredLogEvent = (output, context) => {
    return {
        ...
        ingestionTime: smithy_client_1.expectLong(output.ingestionTime),
...
const deserializeAws_json1_1LogGroup = (output, context) => {
    return {
        ...
        logGroupName: smithy_client_1.expectString(output.logGroupName),
        metricFilterCount: smithy_client_1.expectInt32(output.metricFilterCount),
        retentionInDays: smithy_client_1.expectInt32(output.retentionInDays),
        storedBytes: smithy_client_1.expectLong(output.storedBytes),
    };
};
const deserializeAws_json1_1LogGroupField = (output, context) => {
    return {
        name: smithy_client_1.expectString(output.name),
        percent: smithy_client_1.expectInt32(output.percent),
    };
};
...
const deserializeAws_json1_1LogStream = (output, context) => {
    return {
        arn: smithy_client_1.expectString(output.arn),
        creationTime: smithy_client_1.expectLong(output.creationTime),
        firstEventTimestamp: smithy_client_1.expectLong(output.firstEventTimestamp),
        lastEventTimestamp: smithy_client_1.expectLong(output.lastEventTimestamp),
        lastIngestionTime: smithy_client_1.expectLong(output.lastIngestionTime),
        logStreamName: smithy_client_1.expectString(output.logStreamName),
        storedBytes: smithy_client_1.expectLong(output.storedBytes),
        uploadSequenceToken: smithy_client_1.expectString(output.uploadSequenceToken),
    };
};
...
const deserializeAws_json1_1MetricFilter = (output, context) => {
    return {
        creationTime: smithy_client_1.expectLong(output.creationTime),
        filterName: smithy_client_1.expectString(output.filterName),
        filterPattern: smithy_client_1.expectString(output.filterPattern),
        logGroupName: smithy_client_1.expectString(output.logGroupName),
...
const deserializeAws_json1_1MetricFilterMatchRecord = (output, context) => {
    return {
        eventMessage: smithy_client_1.expectString(output.eventMessage),
        eventNumber: smithy_client_1.expectLong(output.eventNumber),
...
const deserializeAws_json1_1MetricTransformation = (output, context) => {
    return {
        defaultValue: smithy_client_1.limitedParseDouble(output.defaultValue),
        ...
        metricValue: smithy_client_1.expectString(output.metricValue),
...
const deserializeAws_json1_1PutLogEventsResponse = (output, context) => {
    return {
        nextSequenceToken: smithy_client_1.expectString(output.nextSequenceToken),
...
const deserializeAws_json1_1PutQueryDefinitionResponse = (output, context) => {
    return {
        queryDefinitionId: smithy_client_1.expectString(output.queryDefinitionId),
    };
};
...
const deserializeAws_json1_1QueryCompileErrorLocation = (output, context) => {
    return {
        endCharOffset: smithy_client_1.expectInt32(output.endCharOffset),
        startCharOffset: smithy_client_1.expectInt32(output.startCharOffset),
    };
};
const deserializeAws_json1_1QueryDefinition = (output, context) => {
    return {
        lastModified: smithy_client_1.expectLong(output.lastModified),
...
const deserializeAws_json1_1QueryStatistics = (output, context) => {
    return {
        bytesScanned: smithy_client_1.limitedParseDouble(output.bytesScanned),
        recordsMatched: smithy_client_1.limitedParseDouble(output.recordsMatched),
        recordsScanned: smithy_client_1.limitedParseDouble(output.recordsScanned),
    };
};
const deserializeAws_json1_1RejectedLogEventsInfo = (output, context) => {
    return {
        expiredLogEventEndIndex: smithy_client_1.expectInt32(output.expiredLogEventEndIndex),
        tooNewLogEventStartIndex: smithy_client_1.expectInt32(output.tooNewLogEventStartIndex),
        tooOldLogEventEndIndex: smithy_client_1.expectInt32(output.tooOldLogEventEndIndex),
    };
};
...
const deserializeAws_json1_1ResourcePolicy = (output, context) => {
    return {
        lastUpdatedTime: smithy_client_1.expectLong(output.lastUpdatedTime),
...
const deserializeAws_json1_1SearchedLogStream = (output, context) => {
    return {
        logStreamName: smithy_client_1.expectString(output.logStreamName),
        searchedCompletely: smithy_client_1.expectBoolean(output.searchedCompletely),
    };
};
...
const deserializeAws_json1_1SubscriptionFilter = (output, context) => {
    return {
        ...
        distribution: smithy_client_1.expectString(output.distribution),
        filterName: smithy_client_1.expectString(output.filterName),
        filterPattern: smithy_client_1.expectString(output.filterPattern),
        logGroupName: smithy_client_1.expectString(output.logGroupName),
        roleArn: smithy_client_1.expectString(output.roleArn),
